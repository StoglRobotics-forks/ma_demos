...
def generate_launch_description():
    ...
    delay_load_fpc_after_joint_state_broadcaster_spawner = RegisterEventHandler(
    ...
    nodes = [
        ...
        delay_load_fpc_after_joint_state_broadcaster_spawner,
        delay_chained_jtc_spawner_after_load_fpc,
    ]
